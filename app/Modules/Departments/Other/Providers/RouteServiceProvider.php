...
namespace App\Modules\Departments\Other\Providers;
...
use App\Modules\Departments\Clients\API\Routes\APIv1Router;
...
class RouteServiceProvider extends ServiceProvider
{
  ...
  protected $namespaces = [
        'api' => 'App\Modules\Departments\Clients\API\Controllers'
    ];
  ...
  public function registerRouteBindings()
  {
      Route::bind('department',function ($value){
          $department = Departments::repository()->get($value);
