...
namespace App\Modules\Documents\Other\Providers;
...
use App\Modules\Documents\Clients\API\Routes\APIv1Router;
...
class RouteServiceProvider extends ServiceProvider
{
  ...
  protected $namespaces = [
        'api' => 'App\Modules\Documents\Clients\API\Controllers'
    ];
  ...
  public function registerRouteBindings()
  {
      Route::bind('document',function ($value){
          $document = Documents::repository()->get($value);
